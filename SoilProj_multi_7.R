...
colorlegend(posx = c(0.32, 0.35), 
            col = intpalette(c("yellow", "yellow2","orange2","orange1","orange"), 100), 
            zlim = c(l2, l3), 
...
colorlegend(posx = c(0.77, 0.80), 
            ...
            zlim = c(l5, l6), 
            zval = c(l5, l5+0.2*(l6-l5), l5+0.4*(l6-l5), l5+0.6*(l6-l5), l5+0.8*(l6-l5), l6))
