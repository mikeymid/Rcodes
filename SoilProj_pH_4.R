...
#-------- should find a way to cope up with the empty subsets rather than getting errors
...
#ncol means the last column there
...
#plot the points
#points(FDsf,pch=15,cex=0.8,col=FDsf$colsoil) - this might not give you the exact results - use the code below
points(FDsf,pch=15,cex=3.52,col=rgb(FDsf@data$red,FDsf@data$green,FDsf@data$blue))

#This code works perfectly and give you the results - but might show some errors in regions where the subsets are empty
